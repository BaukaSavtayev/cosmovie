...
<div class="folder-preview-card">
	<div class="file-content" onclick="get_shared_list('{$link}'); return false;">
		<img src="engine/skins/images/folder.png" class="file-preview-image">
	</div>
	<div class="file-footer">
		<div class="file-footer-caption">
...
HTML;
	...
	foreach ( $files['files'] as $entryname ) {
		...
		$folder_list[] = <<<HTML
<div class="file-preview-card" data-type="image" data-area="shared" data-url="{$img_url}">
	...
	<div class="file-footer">
		...
		<div class="file-footer-bottom">
			<div class="file-preview"><a onclick="return hs.expand(this); return false;" href="{$img_url}"><i class="mediaupload-icon mediaupload-icon-zoom"></i></a></div>
		</div>
	</div>
</div>
HTML;
