...
HTML;
		...
		$rated = <<<HTML
<div id="starrating" {$shema_title}>
	<div id="stars" data-id="6">
		<a href="#" onclick="doRate('10', '{$id}'); return false;"><span class="fa fa-star"></span></a>
		<a href="#" onclick="doRate('9', '{$id}'); return false;"><span class="fa fa-star"></span></a>
		<a href="#" onclick="doRate('8', '{$id}'); return false;"><span class="fa fa-star"></span></a>
		<a href="#" onclick="doRate('7', '{$id}'); return false;"><span class="fa fa-star"></span></a>
		<a href="#" onclick="doRate('6', '{$id}'); return false;"><span class="fa fa-star"></span></a>
		<a href="#" onclick="doRate('5', '{$id}'); return false;"><span class="fa fa-star"></span></a>
		<a href="#" onclick="doRate('4', '{$id}'); return false;"><span class="fa fa-star"></span></a>
		<a href="#" onclick="doRate('3', '{$id}'); return false;"><span class="fa fa-star"></span></a>
		<a href="#" onclick="doRate('2', '{$id}'); return false;"><span class="fa fa-star"></span></a>
		<a href="#" onclick="doRate('1', '{$id}'); return false;"><span class="fa fa-star"></span></a>
	</div>{$shema}
	<div id="empty-stars">
